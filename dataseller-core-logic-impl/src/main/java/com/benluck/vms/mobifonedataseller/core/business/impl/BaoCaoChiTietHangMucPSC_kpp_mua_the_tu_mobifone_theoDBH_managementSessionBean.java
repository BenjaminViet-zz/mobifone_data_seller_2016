 ...
 */
@Stateless(name = "BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoDBH_managementSessionEJB")
public class BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoDBH_managementSessionBean implements BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoDBH_managementLocalBean{
    @EJB
    private CTTichDiemLocalBean ctTichDiemLocalBean;

    public BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoDBH_managementSessionBean() {
    }
    ...
    public Object[] search(Map<String, Object> properties, Integer firstItem, Integer reportMaxPageItems, String sortExpression, String sortDirection) {
        Object[] resultObject = this.ctTichDiemLocalBean.baoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobiFone_theoDaiLy(properties, firstItem, reportMaxPageItems, sortExpression, sortDirection);
        List<BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoDBHDTO> dtoList = new ArrayList<BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoDBHDTO>();
        for(Object object : (List)resultObject[1]){
            Object[] tmpArr = (Object[])object;
            BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoDBHDTO dto = new BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoDBHDTO();
