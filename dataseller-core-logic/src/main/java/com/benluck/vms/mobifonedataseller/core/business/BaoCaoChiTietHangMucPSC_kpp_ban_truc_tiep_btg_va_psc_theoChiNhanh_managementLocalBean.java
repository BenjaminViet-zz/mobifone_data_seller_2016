 ...
 */
public interface BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoChiNhanh_managementLocalBean {

    /**
     * Get data for report PSC_ItemDetail_KPP_BTG_ByBranch.
     * @param properties
     * @param firstItem
