 ...
 */
public interface BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoChiNhanh_managementLocalBean {

    /**
     * Get data for report PSCItemDetail_KPP_CardFromMobiFone_ByBranch.
     * @param properties
     * @param firstItem
