 ...
 */
public interface BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoQuanHuyen_managementLocalBean {

    /**
     * Get data for report PSCItemDetail_KPP_CardFromMobiFone_ByDistrict.
     * @param properties
     * @param firstItem
