 ...
 */
public interface BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoQuanHuyen_managementLocalBean {

    /**
     * Get data for report PSC_ItemDetail_KPP_BTG_ByDistrict.
     * @param properties
     * @param firstItem
