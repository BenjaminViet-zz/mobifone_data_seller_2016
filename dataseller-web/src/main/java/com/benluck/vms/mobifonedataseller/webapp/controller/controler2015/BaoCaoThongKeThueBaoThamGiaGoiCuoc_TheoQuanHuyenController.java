 ...
 */
@Controller
public class BaoCaoThongKeThueBaoThamGiaGoiCuoc_TheoQuanHuyenController extends ApplicationObjectSupport {
    private org.apache.commons.logging.Log log = LogFactory.getLog(BaoCaoThongKeThueBaoThamGiaGoiCuoc_TheoQuanHuyenController.class);
    ...
    @RequestMapping(value = {"/admin/thuebaophattrienmoi/baocaothongkethuebao_thamgiagoicuoc_theoquanhuyen.html",
            "/chinhanh/thuebaophattrienmoi/baocaothongkethuebao_thamgiagoicuoc_theoquanhuyen.html",
            "/baocao/thuebaophattrienmoi/baocaothongkethuebao_thamgiagoicuoc_theoquanhuyen.html"})
    public ModelAndView report(@ModelAttribute(value = Constants.FORM_MODEL_KEY)BaoCaoThongKeThueBaoThamGiaGoiCuocCommand command,
        ...
        ModelAndView mav = new ModelAndView("2015/thuebaophattrienmoi/admin/baocaothongkethuebaothamgiagoicuoc/theoquanhuyen");
        ...
        if (StringUtils.isNotBlank(crudaction)){
            if (crudaction.equals("search")){
                ...
                Object[] results = this.baoCaoThongKeThueBaoThamGiaGoiCuocService.baoCaoThongKeThueBaoThamGiaGoiCuoc_TheoQuanHuyen(properties, command.getSortExpression(), command.getSortDirection(), command.getFirstItem(), command.getMaxPageItems());
    ...
    private void export2Excel(BaoCaoThongKeThueBaoThamGiaGoiCuocCommand command, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try{
            ...
            String outputFileName = "/files/temp/baocaothongkethuebao_thamgiachuongtrinh_theoquanhuyen" + ngayXuatBaoCao + ".xls";
            String reportTemplate = request.getSession().getServletContext().getRealPath("/files/temp/export/thuebaoptm_2015/baocaothongkethuebao_thamgiachuongtrinh_theoquanhuyen.xls");
