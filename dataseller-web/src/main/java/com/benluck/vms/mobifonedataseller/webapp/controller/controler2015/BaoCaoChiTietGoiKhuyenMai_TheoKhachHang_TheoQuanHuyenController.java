 ...
 */
@Controller
public class BaoCaoChiTietGoiKhuyenMai_TheoKhachHang_TheoQuanHuyenController extends ApplicationObjectSupport {
    private Log log = LogFactory.getLog(BaoCaoChiTietGoiKhuyenMai_TheoKhachHang_TheoQuanHuyenController.class);
    ...
    @RequestMapping(value = {"/admin/thuebaophattrienmoi/baocaochitietgoikm_theoKhachHang_theoquanhuyen.html"})
    public ModelAndView report(@ModelAttribute(value = Constants.FORM_MODEL_KEY)BaoCaoChiTietGoiKhuyenMaiCommand command,
        ...
        ModelAndView mav = new ModelAndView("2015/thuebaophattrienmoi/admin/baocaochitietgoikhuyenmai/theosothuebaokhachhang/theoquanhuyen");
        ...
        if (StringUtils.isNotBlank(crudaction)){
            if (crudaction.equals("search")){
                ...
                Object[] results = this.baoCaoChiTietGoiKhuyenMai_TheoKhachHangService.baoCaoChiTietGoiKhuyenMai_TheoKhachHang_TheoQuanHuyen(properties, command.getSortExpression(), command.getSortDirection(), command.getFirstItem(), command.getMaxPageItems());
    ...
    private void export2Excel(BaoCaoChiTietGoiKhuyenMaiCommand command, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try{
            ...
            String outputFileName = "/files/temp/baocaochitietgoikhuyenmai_theookhachhang_theoquanhuyen" + ngayXuatBaoCao + ".xls";
            String reportTemplate = request.getSession().getServletContext().getRealPath("/files/temp/export/thuebaoptm_2015/baocaochitietgoikhuyenmai_theookhachhang_theoquanhuyen.xls");
