 ...
 */
@Controller
public class ThongTinThueBaoController extends ApplicationObjectSupport{
    ...
    @RequestMapping(value = {"/tongdai/tracuuthongtinthuebao.html","/cuahangmobifone/tracuuthongtinthuebao.html"
                            ,"/admin/tracuuthongtinthuebao.html","/chinhanh/tracuuthongtinthuebao.html"})
    public ModelAndView tracuuthongtinthuebao(@ModelAttribute(value = Constants.FORM_MODEL_KEY)ThongTinThueBaoCommand command,
        ...
        ModelAndView mav = new ModelAndView("/cuahangmobifone/tracuuthongtinthuebao");
        ...
        if(StringUtils.isNotBlank(crudaction) && crudaction.equals("search")){
            ...
            if(!bindingResult.hasErrors() && StringUtils.isBlank(command.getMessage())){
                try{
                    ...
                    Integer soDiemHientai = this.thongTinThueBaoManagementLocalBean.getSoDiemHienTai_tdcg(command.getThue_bao());
                    Integer soPhieuDaDoi = this.thongTinThueBaoManagementLocalBean.getSoPhieuDaDoi_tdcg(command.getThue_bao());
                    Object[] resultObject = this.thongTinThueBaoManagementLocalBean.traCuuThongTinThueBao_tdcg(command.getThue_bao(), command.getFirstItem(), command.getMaxPageItems(), command.getSortExpression(), command.getSortDirection());
                    ...
                    Object[] resultObject1 = this.soDiemCTTichDiemManagementlocalBean.statisticCumulativeScoresByMonth_tdcg(command.getThue_bao());
    ...
    @RequestMapping(value = {"/ajax/cuahangmobifone/loadajaxmaphieulist.html","/ajax/tongdai/loadajaxmaphieulist.html","/ajax/admin/loadajaxmaphieulist.html"}, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {"/ajax/cuahangmobifone/loadlichsudiemtheongay.html"
                            ,"/ajax/tongdai/loadlichsudiemtheongay.html"
                            ,"/ajax/admin/loadlichsudiemtheongay.html"
                            ,"/ajax/chinhanh/loadlichsudiemtheongay.html"})
    public ModelAndView loadLichSuDiemTheoNgay(@ModelAttribute(value = Constants.FORM_MODEL_KEY)ThongTinThueBaoCommand command,
                                               ...
                                               HttpServletRequest request){
        ModelAndView mav = new ModelAndView("/cuahangmobifone/thongtinthuebao_lichsudiemtheongay");
