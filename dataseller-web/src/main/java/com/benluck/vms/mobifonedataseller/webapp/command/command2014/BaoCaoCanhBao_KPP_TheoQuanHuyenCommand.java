 ...
 */
public class BaoCaoCanhBao_KPP_TheoQuanHuyenCommand extends AbstractCommand<BaoCaoCanhBao_KPP_TheoQuanHuyenDTO> {
    public BaoCaoCanhBao_KPP_TheoQuanHuyenCommand(){
        this.pojo = new BaoCaoCanhBao_KPP_TheoQuanHuyenDTO();
    }
