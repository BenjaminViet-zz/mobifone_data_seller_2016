 ...
 */
public class BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoDBHCommand extends AbstractCommand<BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoDBHDTO> {
    public BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoDBHCommand(){
        this.pojo = new BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoDBHDTO();
    }
