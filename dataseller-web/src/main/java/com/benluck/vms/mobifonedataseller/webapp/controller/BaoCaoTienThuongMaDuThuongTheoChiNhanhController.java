 ...
 */
@Controller
public class BaoCaoTienThuongMaDuThuongTheoChiNhanhController extends ApplicationObjectSupport{
    ...
    @RequestMapping(value = {"/admin/baocaotienthuongmaduthuongtheochinhanh.html","/chinhanh/baocaotienthuongmaduthuongtheochinhanh.html"})
    public ModelAndView baoCaoTienThuongMaDuThuong(@ModelAttribute(value = Constants.FORM_MODEL_KEY)BaoCaoTienThuongMaDuThuongCommand command,
        ...
        ModelAndView mav = new ModelAndView("/admin/baocaotienthuongmaduthuongtheochinhanh");
        ...
        if(StringUtils.isNotBlank(crudaction)){
            if(crudaction.equals("search")){
                ...
                Object[] resultObject = this.baoCaoTienThuongMaDuThuongManagementLocalBean.baoCaoTienThuongMaDuThuongTheoChiNhanh(properties, command.getFirstItem(), command.getReportMaxPageItems(), command.getSortExpression(), command.getSortDirection());
    ...
    private void export2Excel(BaoCaoTienThuongMaDuThuongCommand command, HttpServletRequest request,HttpServletResponse response)throws Exception{
        try{
            ...
            convertDate2Timestamp(command);
            Map<String, Object> properties = buildProperties(command);
            Object[] resultObject = this.baoCaoTienThuongMaDuThuongManagementLocalBean.baoCaoTienThuongMaDuThuongTheoChiNhanh(properties, 0, Integer.MAX_VALUE, command.getSortExpression(), command.getSortDirection());
            List<BaoCaoTienThuongMaDuThuongDTO> dtoList = (List<BaoCaoTienThuongMaDuThuongDTO>)resultObject[1];
            String outputFileName = "/files/temp/baocaotienthuongmaduthuongtheochinhanh_" + ngayXuatBaoCao + ".xls";
            String reportTemplate = request.getSession().getServletContext().getRealPath("/files/temp/export/baocaotienthuongmaduthuongtheochinhanh.xls");
            ...
            throw new Exception("Failed to export to excel BaoCaoTienThuongMaDuThuongTheoChiNhanh. \n" + e.getMessage());
        }
    }
