 ...
 */
public class BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoQuanHuyenCommand extends AbstractCommand<BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoQuanHuyenDTO> {
    public BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoQuanHuyenCommand(){
        this.pojo = new BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoQuanHuyenDTO();
    }
