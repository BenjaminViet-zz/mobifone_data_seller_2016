 ...
 */
public class BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoChiNhanhCommand extends AbstractCommand<BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoChiNhanhDTO> {
    public BaoCaoChiTietHangMucPSC_kpp_ban_truc_tiep_btg_va_psc_theoChiNhanhCommand(){
        this.pojo = new BaoCaoChiTietHangMucPSCKPP_ban_truc_tiep_btg_va_psc_TheoChiNhanhDTO();
    }
