 ...
 */
public class BaoCaoChiTietHangMucPSC_kpp_ban_vas_theoDBHCommand extends AbstractCommand<BaoCaoChiTietHangMucPSCKPP_ban_vas_TheoDBHDTO> {
    public BaoCaoChiTietHangMucPSC_kpp_ban_vas_theoDBHCommand(){
        this.pojo = new BaoCaoChiTietHangMucPSCKPP_ban_vas_TheoDBHDTO();
    }
