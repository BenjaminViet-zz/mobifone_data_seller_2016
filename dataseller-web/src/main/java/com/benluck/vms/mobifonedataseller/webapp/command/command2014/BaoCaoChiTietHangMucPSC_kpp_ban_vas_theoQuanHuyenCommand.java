 ...
 */
public class BaoCaoChiTietHangMucPSC_kpp_ban_vas_theoQuanHuyenCommand extends AbstractCommand<BaoCaoChiTietHangMucPSCKPP_ban_vas_TheoQuanHuyenDTO> {
    public BaoCaoChiTietHangMucPSC_kpp_ban_vas_theoQuanHuyenCommand(){
        this.pojo = new BaoCaoChiTietHangMucPSCKPP_ban_vas_TheoQuanHuyenDTO();
    }
