...
import com.benluck.vms.mobifonedataseller.webapp.command.command2014.BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand;
 ...
 */
@Controller
public class BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenController extends ApplicationObjectSupport {
    private Log log = LogFactory.getLog(BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenController.class);
    private static final Integer TOTAL_COLUMN_EXPORT = 8;

    @Autowired
    private BaoCaoChiTietHangMucPSC_kpp_mua_the_tu_mobifone_theoQuanHuyen_managementLocalBean reportManagementLocalBean;
    @Autowired
    ...
    @RequestMapping(value = {"/admin/baocaochitiethangmucpsc_mua_the_tu_Mobifone_theoquanhuyen.html","/chinhanh/baocaochitiethangmucpsc_mua_the_tu_Mobifone_theoquanhuyen.html"})
    public ModelAndView report(@ModelAttribute(value = Constants.FORM_MODEL_KEY)BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand command,
                               HttpServletRequest request,
                               HttpServletResponse response){
        ModelAndView mav = new ModelAndView("/admin/baocaochitiethangmucpsc/muathetumobifone/theoquanhuyen");
        ...
        if(StringUtils.isNotBlank(crudaction)){
            if(crudaction.equals("search")){
                ...
                command.setListResult((List<BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoQuanHuyenDTO>)resultObject[1]);
    ...
    private void referenceData(BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand command, ModelAndView mav){
    ...
    private Map<String, Object> buildProperties(BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand command){
    ...
    private void convertDate2Timestamp(BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand command){
    ...
    private void export2Excel(BaoCaoChiTietHangMucPSC_kpp_muaTheTuMobiFone_theoQuanHuyenCommand command, HttpServletRequest request,HttpServletResponse response)throws Exception{
        try{
            ...
            List<BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoQuanHuyenDTO> dtoList = (List<BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoQuanHuyenDTO>)resultObject[1];
            ...
            if(dtoList.size() > 0){
                int indexRow = 1;
                for(BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoQuanHuyenDTO dto : dtoList){
    ...
    private CellValue[] addCellValues(BaoCaoChiTietHangMucPSCKPP_MuaTheTuMobiFone_TheoQuanHuyenDTO dto, int indexRow){
        SimpleDateFormat df = new SimpleDateFormat("dd-M-yyyy");
