 ...
 */
public class BaoCaoTinNhan_kpp_theoChiNhanhCommand extends AbstractCommand<BaoCaoTinNhan_KPP_TheoChiNhanhDTO> {
    public BaoCaoTinNhan_kpp_theoChiNhanhCommand(){
        this.pojo = new BaoCaoTinNhan_KPP_TheoChiNhanhDTO();
    }
