...
import com.benluck.vms.mobifonedataseller.webapp.command.command2014.BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand;
 ...
 */
@Controller
public class BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenController extends ApplicationObjectSupport{
    private Log log = LogFactory.getLog(BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenController.class);

    @Autowired
    private BaoCaoTongHopChuongTrinh_kpp_theoQuanHuyenManagementLocalBean reportManagementLocalBean;
    @Autowired
    ...
    private static final Integer TOTAL_COLUMN_EXPORT_FILTER_DATE = 18;
    private static final Integer TOTAL_COLUMN_EXPORT_NO_FILTER_DATE = 17;
    ...
    @RequestMapping(value = {"/admin/baocaotonghopketquachuongtrinh_kpp_theoquanhuyen.html","/chinhanh/baocaotonghopketquachuongtrinh_kpp_theoquanhuyen.html"})
    public ModelAndView baoCaoTheoQuanHuyen(@ModelAttribute(value = Constants.FORM_MODEL_KEY)BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand command,
                                            HttpServletRequest request,
                                            HttpServletResponse response){
        ModelAndView mav = new ModelAndView("/admin/baocaotonghopketquachuongtrinh_kpp/theoquanhuyen");
    ...
    /**
     * Fetch more related data base on the user role and put them to the model.
     * @param command
     * @param mav
     */
    private void referenceData(BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand command, ModelAndView mav){
     ...
     * @return
     */
    private Map<String, Object> buildProperties(BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand command){
        ...
        if(command.getTrang_thai_dat() != null){
    ...
    /**
     * Get Date value and format it to Timestamp.
     * @param command
     */
    private void convertDate2Timestamp(BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand command){
     ...
     * @throws Exception
     */
    private void export2Excel(BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand command, HttpServletRequest request,HttpServletResponse response)throws Exception{
        try{
            ...
            String outputFileName = "/files/temp/baocaoketquachuongtrinh_kpp_theoquanhuyen_" + ngayXuatBaoCao + ".xls";
            String exportTemplatePath = "/files/temp/export/baocaoketquachuongtrinh_kpp_theoquanhuyen_nofilterdate.xls";
            if(command.getFromDateTime() != null || command.getToDateTime() != null){
                exportTemplatePath = "/files/temp/export/baocaoketquachuongtrinh_kpp_theoquanhuyen_filterdate.xls";
            }
