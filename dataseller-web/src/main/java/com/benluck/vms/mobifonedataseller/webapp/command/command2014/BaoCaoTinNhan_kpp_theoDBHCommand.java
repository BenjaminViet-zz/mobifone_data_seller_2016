 ...
 */
public class BaoCaoTinNhan_kpp_theoDBHCommand extends AbstractCommand<BaoCaoTinNhan_KPP_TheoDBHDTO> {
    public BaoCaoTinNhan_kpp_theoDBHCommand(){
        this.pojo = new BaoCaoTinNhan_KPP_TheoDBHDTO();
    }
