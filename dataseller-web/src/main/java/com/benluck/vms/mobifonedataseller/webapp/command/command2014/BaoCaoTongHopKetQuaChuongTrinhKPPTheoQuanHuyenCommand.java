 ...
 */
public class BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand extends AbstractCommand<BaoCaoTongHopKetQuaChuongTrinhKPPTheoChiNhanhOrQuanHuyenDTO> {
    public BaoCaoTongHopKetQuaChuongTrinhKPPTheoQuanHuyenCommand(){
