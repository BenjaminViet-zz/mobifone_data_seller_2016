...
<c:url var="formUrl" value="${prefix}/qstudent/tracuutheosothuebao.html"/>
...
<div class="contentpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:if test="${not empty items.listResult}">
                                        <security:authorize ifAnyGranted="NHANVIEN">
                                            ...
                                            <a class="btn btn-danger" onclick="javascript: cancelExchange();" ><fmt:message key="label.huy_doi_qua" /></a>
                                        </security:authorize>
                                    </c:if>
                                    <c:if test="${not empty items.listResult}">
                        ...
                        <div class="table-responsive">
                            <div id="tableList_wrapper" class="dataTables_wrapper" role="grid" >
                                <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formlUrl}"
                                    ...
                                    <display:column headerClass="table_header_center" sortable="false" class="text-center" style="width: 5%;" title="<input type=\"checkbox\" name=\"allCheck\" id=\"allCheck\" onclick=\"checkAll('listForm', 'checkListHuy', this)\">">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-8">
                                                <a id="submitPaymentBtn" class="btn btn-success btnSubmit" onclick="javascript: deliverGift();"><fmt:message key="label.giao_qua" /></a>&nbsp;
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function(){
            setActiveMenu4Admin('#qStudent2015DoiQuaTheoSoThueBao');
            $('checkbox').select2();
        ...
        function cancelExchange(){
            $('#crudaction').val('cancel-exchange');
