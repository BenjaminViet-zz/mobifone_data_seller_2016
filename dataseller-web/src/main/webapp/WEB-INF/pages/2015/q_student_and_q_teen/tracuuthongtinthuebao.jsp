...
<c:url var="formUrl" value="${prefix}/qstudent/tracuuthongtinthuebao.html"/>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#qStudent2015TraCuuThongTinThueBao');
        $('#').addClass('active');
    ...
    function filterAjaxLichSuDiemTheoNgay(tableParamPagination){
        ...
        $.ajax({
            url: '<c:url value="/ajax${prefix}/qstudent/loadlichsudiemtheongay.html" />',
            type: 'get',
            dataType: 'json',
            data: params,
            complete: function(res){
