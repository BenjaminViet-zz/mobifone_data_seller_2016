...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaochitrakhuyenkhich_cho_dbh_theoquanhuyen.html"/>
<body>
...
<script type="text/javascript">
        $(document).ready(function(){
            setActiveMenu4Admin('#menuBaoCaoTBPTMTab', '#bcChiTraKhuyenKhichTheoQuanHuyenTab');
