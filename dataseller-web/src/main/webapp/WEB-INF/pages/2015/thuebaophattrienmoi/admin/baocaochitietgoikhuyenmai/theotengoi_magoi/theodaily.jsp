...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaochitietgoikm_theomagoivatengoi_theodaily.html"/>
<body>
                ...
                <form:form commandName="item" id="reportForm" action="${formUrl}" method="post" autocomplete="off" validate="validate">
                    ...
                    <div id="reportTableContainer" style="width: 100%;">
                        <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                            ...
                            <display:column headerClass="table_header_center nowrap" sortable="false" property="soThueBao" titleKey="label.so_thue_bao" class="nowrap text-center" style="width: 150px;" />
                            <display:column headerClass="table_header_center nowrap" sortable="false" titleKey="label.loai_thue_bao" class="nowrap text-center" style="width: 150px;" >
                                <c:choose>
                                    <c:when test="${tableList.loaiThueBao eq 'TON'}"><fmt:message key="label.cu" /></c:when>
                                    <c:otherwise><fmt:message key="label.moi" /></c:otherwise>
                                </c:choose>
                            </display:column>
