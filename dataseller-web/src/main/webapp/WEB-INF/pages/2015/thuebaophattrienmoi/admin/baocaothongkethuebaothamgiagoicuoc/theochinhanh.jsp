...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaothongkethuebao_thamgiagoicuoc_theochinhanh.html"/>
<body>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#menuBaoCaoTBPTMTab', '#bcThongKeThueBaoTGGCTheoChiNhanhTab');
