...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaochitietgoikm_theomagoivatengoi_theochinhanh.html"/>
<body>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center nowrap" sortable="false" property="branch.branch_name" titleKey="label.chi_nhanh" class="nowrap" style="width: 20%;" />
                                <display:column headerClass="table_header_center nowrap" sortable="false" titleKey="label.thang_dang_ky" class="nowrap text-center" style="width: 15%;" >
                                ...
                                <display:column headerClass="table_header_center nowrap" sortable="false" titleKey="label.thoi_gian_dang_ky" class="nowrap text-center" style="width: 15%" >
                                    <fmt:formatDate value="${tableList.thoiGianDK}" pattern="${dateTimePattern}" />
                                </display:column>
                                <display:column headerClass="table_header_center nowrap" sortable="false" titleKey="label.tinhtrang" class="nowrap" style="width: 15%" >
                                    <c:choose>
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.lydo" style="width: 15%;" >
                                    <c:choose>
                                        <c:when test="${not empty tableList.tinhTrang && tableList.tinhTrang eq Constants.TINH_TRANG_KHONG_THANH_CONG}">
