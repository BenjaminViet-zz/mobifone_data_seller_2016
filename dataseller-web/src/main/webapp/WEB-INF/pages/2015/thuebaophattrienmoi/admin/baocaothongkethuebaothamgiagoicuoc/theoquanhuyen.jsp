...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaothongkethuebao_thamgiagoicuoc_theoquanhuyen.html"/>
<body>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="promPackage.package_Name" titleKey="label.goi_cuoc" class="nowrap" style="width: 150px;" >
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.thoi_gian_dang_ky" class="nowrap text-center" style="width: 150px;" >
                                    <fmt:formatDate value="${tableList.thoiGianDK}" pattern="${datePattern}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.tinhtrang" style="width: 150px;" >
                                    <c:choose>
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.lydo" class="text-right" style="width: 150px;" >
                                    <c:choose>
                                        <c:when test="${not empty tableList.tinhTrang && tableList.tinhTrang eq Constants.TINH_TRANG_KHONG_THANH_CONG}">
                                            <fmt:formatDate type="text" value="${tableList.transError}"/>
                                        </c:when>
                                        <c:when test="${not empty tableList.tinhTrang && tableList.tinhTrang eq Constants.TINH_TRANG_THANH_CONG}">
                                            <fmt:formatDate type="text" value="${tableList.promConditionError}"/>
                                        </c:when>
                                    </c:choose>
                                </display:column>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#menuBaoCaoTBPTMTab', '#bcThongKeThueBaoTGGCTheoQuanHuyenTab');
