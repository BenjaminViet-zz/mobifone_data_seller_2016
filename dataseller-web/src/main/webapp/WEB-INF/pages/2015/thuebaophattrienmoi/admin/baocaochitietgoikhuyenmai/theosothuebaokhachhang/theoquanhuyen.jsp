...
<c:url var="formUrl" value="${prefix}/thuebaophattrienmoi/baocaochitietgoikm_theoKhachHang_theoquanhuyen.html"/>
<body>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#menuBaoCaoTBPTMTab', '#bcTheoKhachHangTheoQuanHuyenTab');
