...
<c:url var="formUrl" value="${prefix}/khohangcuahangkhac.html"/>
<body>
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="row-fluid report-filter">
                <form:form commandName="item" id="searcForm" action="${formUrl}" method="post" autocomplete="off">
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="tableList_wrapper" class="dataTables_wrapper" role="grid" >
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formlUrl}"
                                ...
                                <display:column headerClass="table_header_center nowrap" sortable="true" property="chiNhanh" sortName="chiNhanh" class="${highLight} text-center" style="width: 5%;" titleKey="label.chi_nhanh" />
                                ...
                                <display:column headerClass="table_header_center nowrap" sortName="total" sortable="true" titleKey="label.trang_thai_kho" class="${highLight} text-center" style="width: 10%;">
                                    <c:choose>
                                ...
                                <display:column headerClass="table_header_center nowrap" sortName="total" sortable="true" titleKey="label.so_luong" class="${highLight} text-center" style="width: 10%;" >
                    ...
                    <form:hidden id="chiNhanh" path="pojo.chiNhanh" />
                </form:form>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#tdcgTraCuuKhoTab');
    });

    function ajaxGetDepartmentList(){
        $('#chiNhanh').val($('#chiNhanhMenu').val());
