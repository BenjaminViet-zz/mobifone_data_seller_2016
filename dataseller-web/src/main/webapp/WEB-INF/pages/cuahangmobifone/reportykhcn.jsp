...
<c:url var="formUrl" value="${prefix}/baocaotheokhcn.html"/>
<body>
                ...
                <form:form commandName="item" id="reportForm" action="${formUrl}" method="post" autocomplete="off" validate="validate">
                    ...
                    <c:if test="${not empty items.listResult}">
                        <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                            ...
                            <display:column headerClass="table_header_center nowrap" sortable="true" sortName="giftDeliveryThueBao.thueBao" property="giftDeliveryThueBao.thueBao" titleKey="label.so_thue_bao" class="text-center" style="width: 10%;" />
                            <display:column headerClass="table_header_center nowrap" sortable="true" sortName="ma_phieu" property="ma_phieu" titleKey="label.maPhieu" class="text-center nowrap" style="width: 10%;" />
                            ...
                            <display:column headerClass="table_header_center nowrap" sortable="true" sortName="giftDeliveryThueBao.deliveryTime" titleKey="cuahanggiaodich.baocaotheokhcn.label.ngay_giao" class="text-center" style="width: 10%;">
                                <fmt:formatDate value="${tableList.giftDeliveryThueBao.deliveryTime}" pattern="${datePattern}" />
                            </display:column>
                            <display:column headerClass="table_header nowrap" sortable="true" sortName="giftDeliveryThueBao.nvGiao.displayName" property="giftDeliveryThueBao.nvGiao.displayName" titleKey="cuahanggiaodich.baocaotheokhcn.label.nguoi_giao" style="width: 30%;" />
                            <display:column headerClass="table_header nowrap" sortable="true" sortName="giftDeliveryThueBao.nvGiao.displayName" property="giftDeliveryThueBao.nvGiao.department.name" titleKey="label.cua_hang" style="width: 30%;" />
                            <display:column headerClass="table_header_center nowrap" sortable="true" sortName="status" titleKey="cuahanggiaodich.baocaotheokhcn.label.status" class="text-center nowrap" style="width: 20%px;" >
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#tdcg2014ReportTheoKHCNTab');
