...
<c:url var="formUrl" value="${prefix}/tracuutheomaphieu.html"/>
                    ...
                    <div class="table-responsive">
                        <div id="table2_wrapper" class="dataTables_wrapper" role="grid" >
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formlUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" class="text-center" style="width: 5%;" title="<input type=\"checkbox\" name=\"allCheck\" id=\"allCheck\" onclick=\"checkAll('listForm', 'checkList', this)\">">
...
<script language="javascript" type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#tdcgTraCuuTheoMaPhieuTab');
    });
