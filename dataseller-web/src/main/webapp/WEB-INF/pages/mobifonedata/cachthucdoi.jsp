        ...
        <div class="row">
            <div class=" col-xs-12">
                <article id="q-student-the-le-chuong-trinh">
                    ...
                    <div class="text-center"><h1 class="text-red margin-bottom-large"><b>QUY TẮC SỬ DỤNG</b></h1></div>
                    <ul class="ul-thele-q-student">
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Mỗi một data_code chỉ sử dụng cho duy nhất 01 thuê bao, áp dụng cho cả thuê bao trả trước hoặc trả sau, thuê bao có gói Mobile Internet nền hoặc chưa có gói Mobile Internet.</p></li>
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Mỗi một thuê bao chỉ sử dụng duy nhất 01 data_code tại thời điểm đăng ký data_code hoặc đang trong thời gian sử dụng dung lượng miễn phí của data_code.</p></li>
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Không áp dụng nạp data_code đối với thuê bao khóa 1 chiều hoặc 2 chiều tại thời điểm nạp data_code.</p></li>
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Quy tắc sử dụng data_code:</p>
                            <ul>
                        ...
                        <li><p>Nguyên tắc các gói cước data_code: bổ sung các nội dung sau</p>
                            <ul>
                    ...
                    <h5 class="bg-red box-border text-white padding-round-small display-inline">Trong đó:</h5>
                    <ul class="ul-thele-q-student">
                    ...
                    <h5 class="bg-red box-border text-white padding-round-small display-inline">Câu lệnh sử dụng data_code và kiểm tra dung lượng data:</h5>
                    <ul class="ul-thele-q-student">

                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Đăng ký: DK_QT_<12 số data_code> gửi 999, dấu “_” là dấu cách</p>
                            <ul>
                        ...
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Kiểm tra dung lượng: KT_DataQT gửi 999</p>
                            <ul>
                                <li>Nội dung tin nhắn thông báo: <i>“Quy Khach con lai x MB toc do cao data qua tang (su dung tai VN), thoi gian su dung den dd/mm/yyyy. Chi tiet lien he 9090”</i>, trong đó x MB tương ứng số MB miễn phí còn lại.</li>
                            </ul>
                        </li>
                        <li><p><i class="fa fa-info-circle" aria-hidden="true"></i> Cước gửi 999: 200 đồng/SMS (đã bao gồm VAT)</p>
                            <ul>
