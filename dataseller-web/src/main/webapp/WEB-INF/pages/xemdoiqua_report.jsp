...
<c:url var="doiQuaUrl" value="/tich-diem-cuoc-goi-nhan-voucher/doi-qua.html" />
<c:url var="kppLogoutUrl" value="/tich-diem-cuoc-goi-nhan-voucher/logout.html" />
            ...
            <div class="col-xs-12 col-sm-3">
                <div class=" bg-blue no-padding box-border">
                    <ul id="right_navigation_bar" class="nav">
                        <li class="<c:if test="${not empty xemDiemFlag && xemDiemFlag}">active</c:if>"><a href="${formUrl}?crudaction=xem-diem" class="text-white">Lịch sử điểm</a></li>
                        <li class="<c:if test="${not empty doiQuaFlag && doiQuaFlag}">active</c:if> border-top"><a class="text-white" href="${formUrl}?crudaction=doi-qua">Đổi quà</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <form:form id="reportForm" action="${formUrl}" commandName="item" cssClass="form-inline" role="form">
                        <c:choose>
                            <c:when test="${not empty xemDiemFlag && xemDiemFlag}">
                                ...
                                <div class="tab-content viewScoreContent">
                                    <div class="tab-pane active" id="statisticByDate">
                                        ...
                                        <h4> <b> <fmt:message key="label.tong_diem" />: <span class=" text-blue">
                                <c:choose>
                            ...
                            <c:when test="${not empty doiQuaFlag && doiQuaFlag}">
                                ...
                                <h2 class="text-red no-margin padding-bottom-large">Đổi quà</h2>
                                <hr />
