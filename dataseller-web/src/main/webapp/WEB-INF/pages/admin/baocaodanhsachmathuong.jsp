...
<html>
<head>
    <title><fmt:message key="admin.baocaodanhsachmathuong.heading_page" /></title>
    <meta name="heading" content="<fmt:message key="admin.baocaodanhsachmathuong.heading_page" />"/>
...
<c:url var="formUrl" value="${prefix}/baocaodanhsachmathuong.html"/>
<body>
<div class="pageheader">
    <h2><i class="fa fa-edit"></i><fmt:message key="admin.baocaodanhsachmathuong.heading_page" /></h2>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.ngay.ps" class="nowrap" style="width: 50px;" >
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="so_EZ" titleKey="label.so_EZ" class="nowrap" style="width: 50px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="ma_So" titleKey="label.ma_so" class="nowrap" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.trung_thuong" class="nowrap" style="width: 100px;" >
                                    <c:choose>
                                        <c:when test="${not empty tableList.trang_thai_trung_thuong && tableList.trang_thai_trung_thuong eq Constants.KPP_MA_THUONG_TRUNG_THUONG}">
                                            <fmt:message key="admin.baocaodanhsachmathuong.label.ma_thuong_trung_thuong" />
                                        </c:when>
                                        <c:when test="${not empty tableList.trang_thai_trung_thuong && tableList.trang_thai_trung_thuong eq Constants.KPP_MA_THUONG_KHONG_TRUNG_THUONG}">
                                            <fmt:message key="admin.baocaodanhsachmathuong.label.ma_thuong_khong_trung_thuong" />
                                        </c:when>
                                        <c:when test="${empty tableList.trang_thai_trung_thuong || tableList.trang_thai_trung_thuong eq Constants.KPP_MA_THUONG_CHUA_QUAY_SO}">
                                            <fmt:message key="admin.baocaodanhsachmathuong.label.ma_thuong_chua_quay_so" />
                                        </c:when>
                                    </c:choose>
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" property="dat_giai" titleKey="label.dat_giai" style="width: 150px;" />
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#tdcg2014ReportDanhSachMaThuongTab');
