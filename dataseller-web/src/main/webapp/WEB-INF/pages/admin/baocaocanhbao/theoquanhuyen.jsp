...
<c:url var="formUrl" value="${prefix}/baocaocanhbao_kpp_theoquanhuyen.html"/>
<body>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                           ...
                                           id="tableList" pagesize="${items.reportMaxPageItems}" export="false" class="tableVms table-hover" style="margin: 1em 0 1.5em; width: 1250px;">
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="thoiGianConLai" titleKey="label.so_ngay_con_lai" class="nowrap text-right" style="width: 150px;" />
