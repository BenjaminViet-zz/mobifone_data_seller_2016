                        ...
                        <c:when test="${item.crudaction eq 'search'}">
                            <div id="tableListContainer" style="width: 100%">
                                <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}" partialList="true" sort="external" size="${items.totalItems}"
                                    ...
                                    <display:column headerClass="table_header text-center" titleKey="payment.management.label.order_amount">
                                        <div style="width: 150px;"><fmt:formatNumber type="number" maxFractionDigits="2" value="${tableList.order.total}" /></div>
                                    </display:column>
                                    <display:column headerClass="table_header text-center" titleKey="payment.management.label.paidAmount">
