...
<html>
<head>
    <title><fmt:message key="admin.baocaohanghoa.heading_page" /></title>
    <meta name="heading" content="<fmt:message key="admin.baocaohanghoa.heading_page" />"/>
...
<c:url var="formUrl" value="${prefix}/baocaohanghoatheodaily.html"/>
<body>
<div class="pageheader">
    <h2><i class="fa fa-edit"></i><fmt:message key="admin.baocaohanghoa.heading_page" /></h2>
                    ...
                    <c:if test="${not empty items.listResult}">
                        ...
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="district_Name" titleKey="label.quan_huyen" class="nowrap" style="width: 100px;" />
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="dealer_Name" titleKey="label.ten-diem_ban_hang" style="width: 200px;" />
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.dt_the_cao" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.card_quantity}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.sl_bo_kit" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.kit_quantity}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.sl_thue_bao_bh" class="text-right" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.bhtt_quantity}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.bh_psc_25k" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.bhtt_psc_25}" maxFractionDigits="2" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_tien_psc" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.psc_amount}" maxFractionDigits="2" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.sl_thue_bao_gt" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.gtkh_quantity}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.thue_bao_gt_psc" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.gtkh_psc_25k}" maxFractionDigits="2" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.sl_vas" class="text-right nowrap" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.vas_quantity}" />
                                </display:column>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#tdcg2014ReportHangHoaTab');
