...
<html>
<head>
    <title><fmt:message key="admin.baocaochitiethangmucpsc_kpp_mua_btg_tu_mobifone.heading_page" /></title>
    <meta name="heading" content="<fmt:message key="admin.baocaochitiethangmucpsc_kpp_mua_btg_tu_mobifone.heading_page" />"/>
</head>
...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_muaBTGTuMobifone_theoquanhuyen.html"/>
<body>
<div class="pageheader">
    <h2><i class="fa fa-edit"></i><fmt:message key="admin.baocaochitiethangmucpsc_kpp_mua_btg_tu_mobifone.heading_page" /></h2>
                ...
                <form:form commandName="item" id="searchForm" action="${formUrl}" method="post" autocomplete="off">
                    ...
                    <c:if test="${not empty items.listResult}">
                        <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                            ...
                            <display:column headerClass="table_header_center nowrap" sortable="false" titleKey="label.stt" class="text-center" style="width: 5%px;" >
                                ${tableList_rowNum + (page * Constants.REPORT_MAXPAGEITEMS)}
                            </display:column>
                            <display:column headerClass="table_header_center" sortable="false" property="branch_Name" titleKey="label.chi_nhanh" class="nowrap" style="width: 20%;" />
                            ...
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.ngay_don_hang" class="nowrap text-center" style="width: 10%;" >
                                <fmt:formatDate value="${tableList.ngay_don_hang}" pattern="${datePattern}" />
                            </display:column>
                            <display:column headerClass="table_header_center" sortable="false" property="donHang" titleKey="label.don_hang" class="text-center" style="width: 15%;" />
                            <display:column headerClass="table_header_center" sortable="false" property="tuSerial" titleKey="label.tu_serial" style="width: 15%;" />
                            <display:column headerClass="table_header_center" sortable="false" property="denSerial" titleKey="label.den_serial" style="width: 15%;" />
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_luong_btg" class="nowrap text-right" style="width: 15%;" >
                                <fmt:formatNumber type="number" value="${tableList.soLuongBTG}" maxFractionDigits="2" />
                            </display:column>
