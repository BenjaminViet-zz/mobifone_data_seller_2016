...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_ban_vas_theoquanhuyen.html"/>
<body>
                ...
                <form:form commandName="item" id="searchForm" action="${formUrl}" method="post" autocomplete="off">
                    ...
                    <c:if test="${not empty items.listResult}">
                        <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                            ...
                            <display:column headerClass="table_header_center" sortable="false" property="district_Name" titleKey="label.quan_huyen" class="nowrap" style="width: 25%" />
                            <display:column headerClass="table_header_center" sortable="false" property="loaiVAS" titleKey="label.loai_vas" style="width: 15%;" />
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_luong" class="text-right" style="width: 15%;" >
                                <fmt:formatNumber type="number" value="${tableList.soLuong}" />
                            </display:column>
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.doanh_thu" class="text-right" style="width: 15%;" >
