...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_muaBTGTuMobifone_theodaily.html"/>
<body>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.ngay_don_hang" class="nowrap text-center" style="width: 150px;" >
                                    <fmt:formatDate value="${tableList.ngay_don_hang}" pattern="${datePattern}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" property="donHang" titleKey="label.don_hang" class="text-center" style="width: 150px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="tuSerial" titleKey="label.tu_serial" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="denSerial" titleKey="label.den_serial" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_luong_btg" class="nowrap text-right" style="width: 100px;" >
