...
<html>
<head>
    <title><fmt:message key="admin.baocaochitiethangmucpsc_kpp_gioi_thieu_kh_tham_gia_ctkm.heading_page" /></title>
    <meta name="heading" content="<fmt:message key="admin.baocaochitiethangmucpsc_kpp_gioi_thieu_kh_tham_gia_ctkm.heading_page" />"/>
...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_gioi_thieu_kh_tham_gia_ctkm_theodaily.html"/>
<body>
<div class="pageheader">
    <h2><i class="fa fa-edit"></i><fmt:message key="admin.baocaochitiethangmucpsc_kpp_gioi_thieu_kh_tham_gia_ctkm.heading_page" /></h2>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="thue_bao_kh" titleKey="label.so_thue_bao_khach_hang" class="text-center" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="ngay_kich" titleKey="label.ngay" class="text-center" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="thang_kich" titleKey="label.thang" class="text-center" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="nam_kich" titleKey="label.nam" class="text-center" style="width: 100px;" />
...
<script type="text/javascript">
    ...
    function rebuildTableHeaders(){
        ...
        $('#tableList thead').html("<tr>" +
                ...
                "<th rowspan='2' class='table_header_center '>TB Khách Hàng</th>" +
                "<th colspan='3' class='table_header_center '>Ngày Kích</th>" +
                "<th colspan='5' class='table_header_center '>Cước Phát Sinh / DTTT</th>" +
                "</tr>" +
                "tr>" +
