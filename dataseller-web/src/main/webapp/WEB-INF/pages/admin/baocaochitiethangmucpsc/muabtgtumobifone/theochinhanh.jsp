...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_muaBTGTuMobifone_theochinhanh.html"/>
<body>
                ...
                <form:form commandName="item" id="searchForm" action="${formUrl}" method="post" autocomplete="off">
                    ...
                    <c:if test="${not empty items.listResult}">
                        <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                            ...
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.ngay_don_hang" class="nowrap text-center" style="width: 15%;" >
                            ...
                            <display:column headerClass="table_header_center" sortable="false" property="denSerial" titleKey="label.den_serial" style="width: 10%;" />
                            <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_luong_btg" class="nowrap text-right" style="width: 10%;" >
