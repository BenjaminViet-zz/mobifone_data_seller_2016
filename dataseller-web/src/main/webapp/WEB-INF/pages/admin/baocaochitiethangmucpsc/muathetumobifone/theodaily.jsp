...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_mua_the_tu_Mobifone_theodaily.html"/>
<body>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.doanh_so_the_tren_hoa_don" class="nowrap text-right" style="width: 100px;" >
