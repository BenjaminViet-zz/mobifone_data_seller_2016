...
<html>
<head>
    <title><fmt:message key="admin.baocaochitiethangmucpsc_kpp_ban_vas.heading_page" /></title>
    <meta name="heading" content="<fmt:message key="admin.baocaochitiethangmucpsc_kpp_ban_vas.heading_page" />"/>
...
<c:url var="formUrl" value="${prefix}/baocaochitiethangmucpsc_ban_vas_theodaily.html"/>
<body>
<div class="pageheader">
    <h2><i class="fa fa-edit"></i><fmt:message key="admin.baocaochitiethangmucpsc_kpp_ban_vas.heading_page" /></h2>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                           ...
                                           id="tableList" pagesize="${items.reportMaxPageItems}" export="false" class="tableVms table-hover" style="margin: 1em 0 1.5em; width: 1350px;">
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="dealer_Name" titleKey="label.ten-diem_ban_hang" class="nowrap" style="width: 150px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="soEZ" titleKey="label.so_EZ" class="nowrap text-center" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.ngay_ban_vas" class="nowrap text-center" style="width: 100px;" >
                                    <fmt:formatDate value="${tableList.ngay_ban_vas}" pattern="${datePattern}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" property="soThueBaoKH" titleKey="label.so_thue_bao_khach_hang" class="text-center" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" property="loaiVAS" titleKey="label.loai_vas" style="width: 100px;" />
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.so_luong" class="text-right" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.soLuong}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.doanh_thu" class="text-right" style="width: 100px;" >
                                    <fmt:formatNumber type="number" value="${tableList.doanhThu}" />
                                </display:column>
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.thue_bao_kh_thuoc_ds_nhan_tin_len_he_thong" class="text-right" style="width: 300px;" >
                                    <c:choose>
                                        <c:when test="${not empty tableList.thue_bao_kh_thuoc_ds_nhan_tin_bhtt && tableList.thue_bao_kh_thuoc_ds_nhan_tin_bhtt eq '1'}">
                                            <fmt:message key="label.co" />
                                        </c:when>
                                        <c:otherwise><fmt:message key="label.khong" /></c:otherwise>
                                    </c:choose>
                                </display:column>
