                ...
                <form:form commandName="item" cssClass="form-horizontal form-label-left" id="formEdit" action="${formUrl}" method="post" validate="validate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                            <input type="text" class="form-control has-feedback-left data_picker" value="<fmt:formatDate pattern="${datePattern}" value="${item.pojo.issuedContractDate}" />" name="issuedContractDate" id="issuedContractDate" aria-describedby="inputSuccess2Status4">
