...
<c:url var="formUrl" value="${prefix}/baocaohanghoatheoquanhuyen.html"/>
<body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <c:if test="${not empty item.listResult}">
                    ...
                    <c:if test="${not empty item.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.sl_thue_bao_bh" class="text-right nowrap" style="width: 100px;" >
