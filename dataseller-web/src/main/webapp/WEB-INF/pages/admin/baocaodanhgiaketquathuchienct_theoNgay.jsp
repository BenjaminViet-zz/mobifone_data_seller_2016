            ...
            <div class="row-fluid report-filter">
                <form:form commandName="item" id="searchForm" action="${formUrl}" method="post" autocomplete="off">
                    ...
                    <c:if test="${not empty reportData}">
                        ...
                        Ngày phát sinh:&nbsp;Từ ngày&nbsp;<b>01/09/2014</b> đến ngày <b>30/09/2014</b>.
                        <div class="clear"></div>
                        <div id="reportTableContainer_table1" style="width:100%">
                            <table class="tableVms table-hover" border="1">
                                <tr >
                                    <th rowspan="2" class="table_header_center "><fmt:message key="label.stt" /></th>
                                    <th rowspan="2" class="table_header"><fmt:message key="label.tieu_chi" /></th>
                                    <c:forEach items="${reportData.danhSachNgayRender_tieuChi3And4}" var="ngay">
                                        <th colspan="2" class="table_header_center " style="width: 300px;"><fmt:formatDate value="${ngay.date}" pattern="${datePattern}" /></th>
                                    </c:forEach>
                                </tr>
                                <tr>
                                    <c:forEach items="${reportData.danhSachNgayRender_tieuChi3And4}" var="ngay">
                                ...
                                <tr class="even">
                                    <td class="text-center">1</td>
                                    <td class="nowrap">Số tiền tiêu dùng tài khoản chính tháng 9/2014</td>
                                    <c:forEach items="${reportData.tieuChi3_summary}" var="chiTietNgayData">
                                        <td class="text-center"><fmt:formatNumber type="number" maxFractionDigits="0" value="${chiTietNgayData.doanhThu_sau}" /></td>
                                        <td class="text-center"><fmt:formatNumber type="number" maxFractionDigits="0" value="${chiTietNgayData.doanhThu_truoc}" /></td>
                                    </c:forEach>
                                </tr>
                                <tr class="odd">
                                    <td class="text-center"></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#menuBaoCaoTheoKHCNTab', '#bcDanhGiaKetQuaThucHienCTTab');
