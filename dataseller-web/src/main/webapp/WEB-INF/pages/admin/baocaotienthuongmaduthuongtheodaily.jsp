...
<c:url var="formUrl" value="${prefix}/baocaotienthuongmaduthuongtheodaily.html"/>
<body>
                ...
                <form:form commandName="item" id="searchForm" action="${formUrl}" method="post" autocomplete="off">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label"><fmt:message key="label.trang_thai_tra_thuong" /></label>
                                    <div class="col-sm-8">
                                        <form:select id="trangThaiTraThuongMenu" path="trang_thai_tra_thuong" cssStyle="width: 250px;">
                                            <option value=""><fmt:message key="label.all" /></option>
                                            <option <c:if test="${item.trang_thai_tra_thuong eq Constants.TRANG_THAI_TRA_THUONG_CHUA_CHI_TRA}">selected="true"</c:if> value="${Constants.TRANG_THAI_TRA_THUONG_CHUA_CHI_TRA}"><fmt:message key="label.chua_chi_tra" /></option>
                                            <option <c:if test="${item.trang_thai_tra_thuong eq Constants.TRANG_THAI_TRA_THUONG_DA_CHI_TRA}">selected="true"</c:if> value="${Constants.TRANG_THAI_TRA_THUONG_DA_CHI_TRA}"><fmt:message key="label.da_chi_tra" /></option>
                                        </form:select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <c:if test="${not empty items.listResult}">
                        <div id="reportTableContainer" style="width: 100%;">
                            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                           ...
                                           id="tableList" pagesize="${items.reportMaxPageItems}" export="false" class="tableVms table-hover" style="margin: 1em 0 1.5em; width: 1850px;">
                                ...
                                <display:column headerClass="table_header_center" sortable="false" property="dealer_Code" titleKey="label.ma_diem_ban_hang" class="nowrap" style="width: 150px;" />
                                ...
                                <display:column headerClass="table_header_center" sortable="false" titleKey="label.trang_thai_tra_thuong" class="text-right" style="width: 150px;" >
                                    <c:choose>
                                        <c:when test="${not empty tableList.trang_thai_tra_thuong && tableList.trang_thai_tra_thuong eq Constants.TRANG_THAI_TRA_THUONG_CHUA_CHI_TRA}">
                                            <fmt:message key="label.chua_chi_tra" />
                                        </c:when>
                                        <c:when test="${not empty tableList.trang_thai_tra_thuong && tableList.trang_thai_tra_thuong eq Constants.TRANG_THAI_TRA_THUONG_DA_CHI_TRA}">
                                            <fmt:message key="label.da_chi_tra" />
                                        </c:when>
                                        <c:when test="${not empty tableList.trang_thai_tra_thuong && tableList.trang_thai_tra_thuong eq Constants.TRANG_THAI_TRA_THUONG_KHONG_DAT}">
