...
<head>
    ...
    <title>Mobifone :: | Chương trình phát triển thuê bao</title>
...
<jsp:include page="/common/2015/thuebao_phattrienmoi/header.jsp"/>
<decorator:body/>
<jsp:include page="/common/2015/thuebao_phattrienmoi/footer.jsp"/>
</body>
</html>