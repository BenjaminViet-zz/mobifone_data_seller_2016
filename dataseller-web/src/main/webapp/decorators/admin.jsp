...
<head>
    ...
    <!-- Custom Theme Style -->
    <link href="<c:url value="/themes/newteample/content/css/custom_v1.3.css" />" rel="stylesheet" />

    <link href="<c:url value="/themes/admin/css/admin_v1.6.css" />" rel="stylesheet" />
